...
opt = MyStructureMain(0.0002, False, '/mnt/nvme1/dataset_S2A', '/data/mboumahdi/codes/Tiles_dataset_1.0_256_256.csv', 
                      '/mnt/nvme1/models_decloud/','/mnt/nvme1/models_decloud/', 50, 4,2)
...
if __name__ == '__main__':
    ...
    project_name = f'Sentinel12ResNet_S2A_Tiles_Batch_8_{date}'
...
# Create the SummaryWriter with the specified log directory and filename_suffix
    ...
    writer.add_graph(model, input_to_model=( s1_10, s2_10, s2_20))
...
# load checkpoint if needed/ wanted
    ...
    for epoch in range(start_epoch, opt.epochs + 1):
        ...
        for i, data in pbar:
            ...
            y_hat = model(s1_10, s2_10_input, s2_20_input )
